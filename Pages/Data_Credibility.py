...
def app():
    ...
    if choice=="Country":
        ...
        fig = px.bar(data[data["Country"]!="Pacific"].sort_values("Value"), x = "Value", y = "Country", custom_data=["Country","Value"], orientation = "h",color = "Color",color_discrete_map=info)
