...
**A positive influence of an indicator signifies higher the indicator more resilient the national food system is and vice-versa. All the scores are normalized. Higher value for the indicators with negative influence means the country has less the indicator and vice-versa.*
